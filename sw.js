...
const PRECACHE = [
  ...
  "./js/encourage.js", "./js/adventure.js",
  ...
  "./games/encuentra-error/index.html", "./games/encuentra-error/style.css", "./games/encuentra-error/game.js",
  "./games/cual-es/index.html", "./games/cual-es/style.css", "./games/cual-es/game.js",
...
self.addEventListener("fetch", (e) => {
  ...
  // Recursos externos (Google Fonts): a la red, sin cachear; si falla, no rompe.
  if (req.url.includes("gstatic") || req.url.includes("googleapis")) return;
